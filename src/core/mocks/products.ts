...
const products: Product[] = [
	...
	},
	{
		...
		description: `HUAWEI MateBook D 14 está equipada con una pantalla IPS de 1920x1080.
			Con un peso de solo 1.38 kg1 y un grosor de 15.9 mm2, el diseño aerodinámico no solo se ve genial, significa que puede empujar la bisagra hasta casi 180°.
